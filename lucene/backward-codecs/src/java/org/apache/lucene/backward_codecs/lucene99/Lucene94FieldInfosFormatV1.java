 ...
 *
 * <p>Original Lucene 9.0 Field Infos format.
 *
 ...
 * @lucene.experimental
 */
public final class Lucene94FieldInfosFormatV1 extends FieldInfosFormat {

  /** Sole constructor. */
  public Lucene94FieldInfosFormatV1() {}
      ...
      try {
        int format =
            CodecUtil.checkIndexHeader(
                ...
                Lucene94FieldInfosFormatV1.FORMAT_CURRENT,
                segmentInfo.getId(),
                segmentSuffix);
  ...
  public void write(
    ...
    try (IndexOutput output = directory.createOutput(fileName, context)) {
      CodecUtil.writeIndexHeader(
          output,
          Lucene94FieldInfosFormatV1.CODEC_NAME,
          // [mongot] Write v1 (not FORMAT_CURRENT=2) so 9.11 readers can open these segments
  ...
  // [mongot] The writer uses FORMAT_PARENT_FIELD directly (not FORMAT_CURRENT) to produce v1
  // segments. FORMAT_CURRENT still points to FORMAT_DOCVALUE_SKIPPER to be used by the reader.
